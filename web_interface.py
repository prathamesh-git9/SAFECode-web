#!/usr/bin/env python3
"""
SAFECode-Web Interface
A simple Flask web interface for pasting C code and getting vulnerability analysis.
...
<head>
    ...
    <title>SAFECode-Web - C Code Vulnerability Scanner</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🔒 SAFECode-Web</h1>
            <p>Advanced C/C++ Code Vulnerability Scanner with AI-Powered Analysis</p>
        </div>
        ...
        <div class="footer">
            <p>Powered by Flawfinder SAST + OpenAI GPT | Version 2.0 | Backend: {{ backend_status }}</p>
        </div>
    </div>
    ...
    <script>
        ...
        function displayVulnerabilities(findings) {
            ...
            findings.forEach((finding, index) => {
                ...
                const snippet = finding.snippet ? `<div class="code-snippet">${finding.snippet}</div>` : '';
...
if __name__ == '__main__':
    print("🌐 Starting SAFECode-Web Interface...")
    print(f"📡 Backend URL: {BACKEND_URL}")
    print("🌍 Web Interface: http://localhost:5000")
    print("📚 API Documentation: http://localhost:8002/docs")
    print("\n" + "="*50)
    print("🎯 Open your browser and go to: http://localhost:5000")
    print("📝 Paste your C/C++ code and click 'Scan for Vulnerabilities'")
    print("="*50 + "\n")
